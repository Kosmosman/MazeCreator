...
namespace s21 {
    ...
    class Facade {
    public:
        Facade(Controller *controller, std::vector <Button> *buttons, std::vector <TextTables> *text_labels,
               Field *field) : controller_{controller}, buttons_{buttons}, text_labels_{text_labels},
                               field_{field} { Init(); };
